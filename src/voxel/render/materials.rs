...
impl AsBindGroup for GpuTerrainMaterial {
    ...
    fn as_bind_group(
        ...
        let mut images = vec![];
        for handle in self.textures.iter().take(MAX_MATERIAL_COUNT) {
        ...
        let textures = vec![&fallback_image.texture_view; MAX_MATERIAL_COUNT];
        ...
        voxel_materials
            ...
            .for_each(|(_, material)| {
                gpu_mats.materials.push(GpuVoxelMaterial {
                    ...
                    emissive_r: material.emissive.r(),
                    emissive_g: material.emissive.g(),
                    emissive_b: material.emissive.b(),
                    emissive_a: material.emissive.a(),
